...
class pdPolygon2d:public pdShape2d{
private:
	vector <pdVertex2d*> v2d;
public:
	virtual int Init(pdVertex2d*,int num_of_vertex);
	virtual int Draw(pdParam2d);
};
class pdPolygon3d:public pdShape3d{
private:
	vector <pdVertex3d*> v3d;
public:
	virtual int Init(pdVertex3d*,int num_of_vertex);
	virtual int Draw(pdParam3d);
};
